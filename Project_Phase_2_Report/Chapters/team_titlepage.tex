	\begin{center}
		...
		{\huge {$\mathfrak {Bachelor\; of\; Technology}$}}\\[.1cm]
		%{\Large {$\mathfrak {In}$}}\\[.5cm]
		%{\Large {$\mathfrak {Computer\; Science\; \&\; Engineering}$}}\\[2cm]
		\textit{in}\\[0.1cm]
		{\Large \bf \itshape{{Computer Science and Engineering}}}\\[0.2cm]
		\large \bfseries{By}\\[.2cm]
		\large \bfseries{ Vishwanath Pradeep (U2203212) }\\[0.2cm]
		...
		\large \bfseries{Mr. Sebin Jose\\Assistant Professor\\Dept. of CSE}\\[0.3cm]
