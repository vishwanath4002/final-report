...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{Images/enemy.jpeg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{Images/boss.png}
    \caption{Boss combat encounter in a Unity test scene: a soldier engages a skeletal multi-limbed boss entity at close range.}
    \label{fig:boss}
\end{figure}
